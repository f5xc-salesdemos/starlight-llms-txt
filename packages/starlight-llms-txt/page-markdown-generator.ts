 ...
 */
export async function generatePageMarkdown(doc: CollectionEntry<'docs'>, context: APIContext): Promise<string> {
 ...
 */
async function generateMarkdownForEntry(doc: CollectionEntry<'docs'>, context: APIContext): Promise<string> {
