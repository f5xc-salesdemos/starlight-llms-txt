...
export default defineConfig({
	...
	integrations: [
		starlight({
			...
			description:
				"Generate llms.txt context files for your Starlight documentation site",
			social: [
				{
					icon: "github",
			...
			editLink: {
				baseUrl:
					"https://github.com/f5xc-salesdemos/starlight-llms-txt/edit/main/docs/",
			},
			lastUpdated: true,
			plugins: [
				starlightLlmsTxt({
					...
					optionalLinks: [
						...
						},
						{
							...
							description:
								"documentation for the Starlight documentation framework",
						},
					],
